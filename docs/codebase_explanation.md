# Tài liệu Giải thích Mã nguồn Dự án - Game Trắc nghiệm Đúng/Sai Real-time (MLN131)

Tài liệu này cung cấp cái nhìn toàn diện và chi tiết về cấu trúc thư mục, luồng hoạt động, cơ chế cơ sở dữ liệu và các thành phần giao diện của ứng dụng game trắc nghiệm Đúng/Sai thời gian thực dành cho môn học Tư tưởng Hồ Chí Minh (MLN131).
...
│   ├── questions.ts           # Kho lưu trữ 30 câu hỏi môn học MLN131 (Độ khó: easy/medium/hard)
